...
export default function NotificationsPage() {
  ...
  // Without this, the relative timestamps below stay English ("about 2
  // hours ago") in the middle of otherwise-translated copy — date-fns
  // has no idea what locale next-intl resolved.
